...
namespace QuanLyBanHang.Forms
{
    public partial class frmKhachHang : Form
    {
        ...
        {
            string input = Microsoft.VisualBasic.Interaction.InputBox("Nhập ID khách hàng cần tìm:", "Tìm kiếm", "");

            if (!string.IsNullOrEmpty(input))
            {
                if (int.TryParse(input, out int id))
                {
                    // Thay 'dgvKhachHang' bằng tên DataGridView của bạn
                    ...
                    if (dt != null)
                    {
                        ...
                        {
                            MessageBox.Show("Không tìm thấy khách hàng có ID này!", "Thông báo");
                ...
                {
                    MessageBox.Show("ID phải là số nguyên!", "Lỗi định dạng");
                }
            }
            else
            {
